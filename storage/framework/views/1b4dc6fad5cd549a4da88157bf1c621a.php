...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>SMK Antartika 1 - Tahun <?php echo e(date('Y')); ?></p>
        </div>
        ...
        <div class="content">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
                ...
                <?php if($catatan): ?>
                    <p><strong>Catatan:</strong> <?php echo e($catatan); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="<?php echo e(url('/dashboard')); ?>" class="button">Lihat Dashboard</a>
            </div>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> SMK Antartika 1 - PPDB Online</p>
            <p>Email ini dikirim secara otomatis, mohon tidak membalas email ini.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\Lenovo\Documents\adi_ppdb\aplikasi_ppdb\resources\views/emails/hasil-seleksi.blade.php ENDPATH**/ ?>