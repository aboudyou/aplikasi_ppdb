...
<?php $__env->startSection('content'); ?>
    ...
    <header id="home" class="d-flex align-items-center"
        style="position: relative; min-height: 100dvh; background: url('<?php echo e(asset('assets/images/my/SMK-antartika.jpeg')); ?>') no-repeat center center; background-size: cover;">
        <!-- Overlay -->
        <div
    ...
    <section class="cta-block"
        style="position: relative; padding: 120px 0; background: url('<?php echo e(asset('assets/images/my/Antartika.jpeg')); ?>') no-repeat center center; background-size: cover; background-attachment: fixed;">
        <!-- Overlay -->
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg">Daftar Sekarang <i
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Documents\adi_ppdb\aplikasi_ppdb\resources\views/welcome.blade.php ENDPATH**/ ?>