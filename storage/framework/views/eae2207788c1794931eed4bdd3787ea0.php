...
<?php $__env->startSection('title', 'Seleksi Pendaftar'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($pendaftar->count()); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($pendaftar->where('status_pendaftaran', 'diterima')->count()); ?></h2>
                        </div>
                        <div class="opacity-75">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($pendaftar->where('status_pendaftaran', 'ditolak')->count()); ?></h2>
                        </div>
                        <div class="opacity-75">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($pendaftar->whereIn('status_pendaftaran', ['diterima', 'ditolak'])->count()); ?></h2>
                        </div>
                        <div class="opacity-75">
                            ...
                            <tr class="border-bottom border-light">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-bold"><?php echo e($p->nama_lengkap); ?></h6>
                                            <small class="text-muted"><?php echo e($p->user->email ?? 'N/A'); ?></small>
                                        </div>
                                    </div>
                                </td>
                                <td class="fw-semibold"><?php echo e($p->nisn); ?></td>
                                <td>
                                    <span class="badge bg-light text-dark border"><?php echo e($p->jurusan->nama_jurusan); ?></span>
                                </td>
                                <td>
                                    <span class="badge bg-info bg-opacity-10 text-info border-0"><?php echo e($p->gelombang->nama_gelombang); ?></span>
                                </td>
                                <td>
                                    <?php if($p->status_pendaftaran == 'Draft'): ?>
                                        <span class="badge bg-secondary bg-opacity-10 text-secondary border-0">
                                            <i class="ti ti-edit me-1"></i>Draft
                                        </span>
                                    <?php elseif($p->status_pendaftaran == 'Lengkap'): ?>
                                        <span class="badge bg-info bg-opacity-10 text-info border-0">
                                            <i class="ti ti-check me-1"></i>Lengkap
                                        </span>
                                    <?php elseif($p->status_pendaftaran == 'Diverifikasi'): ?>
                                    ...
                                    <?php else: ?>
                                        <span class="badge bg-secondary bg-opacity-10 text-secondary border-0">
                                            <?php echo e($p->status_pendaftaran ?? 'Belum Diproses'); ?>

                                        </span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                    <?php if($p->status_pendaftaran == 'Diverifikasi'): ?>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <form action="<?php echo e(route('admin.seleksi.update', $p->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Documents\adi_ppdb\aplikasi_ppdb\resources\views/admin/seleksi/index.blade.php ENDPATH**/ ?>