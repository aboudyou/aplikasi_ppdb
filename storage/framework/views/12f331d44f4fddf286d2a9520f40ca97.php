...
<?php $__env->startSection('title', 'Verifikasi Berkas'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($pendaftar->where('status_pendaftaran', 'Lengkap')->count()); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold"><?php echo e($pendaftar->where('status_pendaftaran', 'Diverifikasi')->count()); ?></h2>
                        </div>
                        <div class="opacity-75">
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom border-light">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm me-3" style="background: linear-gradient(135deg, #667eea, #764ba2); color: white; border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; font-weight: bold;">
                                            <?php echo e(strtoupper(substr($p->nama_lengkap ?? $p->user->name ?? 'N', 0, 1))); ?>

                                        </div>
                                        <div>
                                            <h6 class="mb-0 fw-bold"><?php echo e($p->nama_lengkap ?? $p->user->name ?? 'N/A'); ?></h6>
                                            <small class="text-muted"><?php echo e($p->user->email ?? 'N/A'); ?></small>
                                        </div>
                                    </div>
                                </td>
                                <td class="fw-semibold"><?php echo e($p->nisn ?? $p->user->nisn ?? 'N/A'); ?></td>
                                <td class="fw-semibold"><?php echo e($p->asal_sekolah ?? $p->user->asal_sekolah ?? 'N/A'); ?></td>
                                <td>
                                    <?php $status = $p->status_pendaftaran ?? null; ?>
                                    <?php if($status === 'Draft'): ?>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(route('admin.verifikasi.show', $p->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Documents\adi_ppdb\aplikasi_ppdb\resources\views/admin/verifikasi/index.blade.php ENDPATH**/ ?>