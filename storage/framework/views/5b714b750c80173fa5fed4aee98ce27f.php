                ...
                <div class="card-body">
                    <?php if($biodata): ?>
                        ...
                        <div class="text-center mb-4">
                            <?php if($biodata->foto): ?>
                                <img src="<?php echo e(asset('storage/' . $biodata->foto)); ?>" alt="Foto Profil" 
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-2">
                                ...
                                <p class="mb-0"><strong><?php echo e($biodata->nama_lengkap); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Jenis Kelamin</label>
                                <p class="mb-0"><strong><?php echo e($biodata->jenis_kelamin); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">NISN</label>
                                <p class="mb-0"><strong><?php echo e($biodata->nisn); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">NIK</label>
                                <p class="mb-0"><strong><?php echo e($biodata->nik); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Tempat Lahir</label>
                                <p class="mb-0"><strong><?php echo e($biodata->tempat_lahir); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Tanggal Lahir</label>
                                <p class="mb-0"><strong><?php echo e(\Carbon\Carbon::parse($biodata->tanggal_lahir)->format('d-m-Y')); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Agama</label>
                                <p class="mb-0"><strong><?php echo e($biodata->agama); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Anak Ke-</label>
                                <p class="mb-0"><strong><?php echo e($biodata->anak_ke); ?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-2">
                                ...
                                <p class="mb-0"><strong><?php echo e($biodata->tinggi_badan); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Berat Badan (kg)</label>
                                <p class="mb-0"><strong><?php echo e($biodata->berat_badan); ?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 mb-2">
                                ...
                                <p class="mb-0"><strong><?php echo e($biodata->alamat); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Desa/Kelurahan</label>
                                <p class="mb-0"><strong><?php echo e($biodata->kelurahan_desa); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Kecamatan</label>
                                <p class="mb-0"><strong><?php echo e($biodata->kecamatan); ?></strong></p>
                            </div>
                            <div class="col-md-12 mb-2">
                                <label class="text-muted small">Kota/Kabupaten</label>
                                <p class="mb-0"><strong><?php echo e($biodata->kota); ?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-2">
                                ...
                                <p class="mb-0"><strong><?php echo e($biodata->asal_sekolah); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">No. HP</label>
                                <p class="mb-0"><strong><?php echo e($biodata->no_hp); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Jurusan Pilihan</label>
                                <p class="mb-0"><strong><?php echo e($jurusan ? $jurusan->nama_jurusan : '-'); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Gelombang Pendaftaran</label>
                                <p class="mb-0"><strong><?php echo e($gelombang ? $gelombang->nama_gelombang : '-'); ?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-2">
                                ...
                                <p class="mb-0"><strong><?php echo e($biodata->nomor_pendaftaran); ?></strong></p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="text-muted small">Status</label>
                                <p class="mb-0">
                                    <?php if($biodata->status_pendaftaran == 'diterima'): ?>
                                        <span class="badge bg-success">Diterima</span>
                                    <?php elseif($biodata->status_pendaftaran == 'ditolak'): ?>
                                        <span class="badge bg-danger">Ditolak</span>
                                    <?php else: ?>
                                        <span class="badge bg-warning"><?php echo e($biodata->status_pendaftaran); ?></span>
                                    <?php endif; ?>
                                </p>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="alert alert-info">
                            ...
                            <a href="<?php echo e(route('user.biodata')); ?>">Lengkapi biodata Anda sekarang</a>
                        </div>
                    <?php endif; ?>
                </div>
