    ...
    <div class="container">
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <span class="info-value"><strong>{{ $nomor_kuitansi }}</strong></span>
            </div>
            <div class="info-row">
                <span class="info-label">Nama:</span>
                <span class="info-value">{{ $pembayaran->formulir->nama_lengkap }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Gelombang:</span>
                <span class="info-value">{{ $pembayaran->gelombang->nama_gelombang ?? '-' }}</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $pembayaran->verified_at ? $pembayaran->verified_at->format('d F Y H:i') : '-' }}</span>
            </div>
        </div>
        ...
        <div style="text-align: center;">
            <a href="{{ route('user.pembayaran') }}" class="button">
