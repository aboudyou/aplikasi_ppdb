<li class="pc-item"><a href="{{ route('user.biodata') }}" class="pc-link">
...
<li class="pc-item"><a href="{{ route('user.status') }}" class="pc-link">
    <span class="pc-micon"><i class="ti ti-info-circle"></i></span>
    <span class="pc-mtext">Status Seleksi</span></a>
</li>

<li class="pc-item"><a href="{{ route('user.daftar_ulang') }}" class="pc-link">
    <span class="pc-micon"><i class="ti ti-refresh"></i></span>
    <span class="pc-mtext">Daftar Ulang</span></a></li>
