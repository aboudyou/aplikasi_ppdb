...
<div class="container mt-4">
    ...
    <div class="card mt-2 p-4 border-success bg-light">
        <div class="mb-3">
            ...
            <p class="text-muted mb-0"><small>Terakhir diperbarui: {{ $data->updated_at ? $data->updated_at->format('d M Y H:i') : '-' }}</small></p>
        </div>
                ...
                <div class="p-3 border-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="text-muted">{{ $data->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="text-muted">{{ $data->tanggal_lahir ? \Carbon\Carbon::parse($data->tanggal_lahir)->format('d M Y') : '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="text-muted">{{ $data->anak_ke ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="text-muted">{{ $data->tinggi_badan ? $data->tinggi_badan . ' cm' : '-' }}</p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <p><strong>Berat Badan:</strong></p>
                            <p class="text-muted">{{ $data->berat_badan ? $data->berat_badan . ' kg' : '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <p class="text-muted">{{ $data->asal_sekolah ?? '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>

            {{-- Tab 2: Alamat & Jurusan --}}
            <div class="tab-pane fade" id="tab2" role="tabpanel">
                <div class="p-3 border-top">
                    <h6 class="mb-3"><strong>Alamat Lengkap</strong></h6>
                    <p class="text-muted mb-3">{{ $data->alamat ?? '-' }}</p>

                    <div class="row mb-4">
                        <div class="col-md-3 mb-2">
                            <p><strong>Desa:</strong> <span class="text-muted">{{ $data->desa ?? '-' }}</span></p>
                        </div>
                        <div class="col-md-3 mb-2">
                            <p><strong>Kelurahan:</strong> <span class="text-muted">{{ $data->kelurahan ?? '-' }}</span></p>
                        </div>
                        <div class="col-md-3 mb-2">
                            <p><strong>Kecamatan:</strong> <span class="text-muted">{{ $data->kecamatan ?? '-' }}</span></p>
                        </div>
                        <div class="col-md-3 mb-2">
                            <p><strong>Kota:</strong> <span class="text-muted">{{ $data->kota ?? '-' }}</span></p>
                        </div>
                    </div>

                    <p class="mb-3"><strong>No. HP:</strong> <span class="text-muted">{{ $data->no_hp ?? '-' }}</span></p>

                    <div class="row mt-4 pt-3 border-top">
                        <div class="col-md-6 mb-3">
                            <p><strong>Jurusan:</strong></p>
                            <p class="text-muted">{{ optional($data->jurusan)->nama_jurusan ?? '-' }}</p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <p><strong>Gelombang Pendaftaran:</strong></p>
                            <p class="text-muted">{{ optional($data->gelombang)->nama_gelombang ?? '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
