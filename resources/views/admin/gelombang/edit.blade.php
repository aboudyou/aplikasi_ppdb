...
<div class="container-fluid px-3 mt-4">
    <h3 class="mb-4"><i class="bi bi-calendar-event"></i> Edit Gelombang Pendaftaran</h3>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-bottom-0 py-3">
            <h5 class="mb-0 fw-bold text-dark">
                <i class="bi bi-calendar-event me-2 text-primary"></i>Informasi Gelombang: {{ $gelombang->nama_gelombang }}
            </h5>
        </div>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control form-control-lg @error('tanggal_mulai') is-invalid @enderror"
                               ...
                               value="{{ old('tanggal_mulai', $gelombang->tanggal_mulai ? \Carbon\Carbon::parse($gelombang->tanggal_mulai)->format('Y-m-d') : '') }}" required>
                        @error('tanggal_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control form-control-lg @error('tanggal_selesai') is-invalid @enderror"
                               ...
                               value="{{ old('tanggal_selesai', $gelombang->tanggal_selesai ? \Carbon\Carbon::parse($gelombang->tanggal_selesai)->format('Y-m-d') : '') }}" required>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="number" class="form-control @error('nilai') is-invalid @enderror"
                                   id="nilai" name="nilai"
                                   value="{{ old('nilai', $gelombang->nilai) }}"
                                   placeholder="0"
                                   min="0" required>
                            @error('nilai')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control form-control-lg @error('kuota_maksimal') is-invalid @enderror"
                               ...
                               value="{{ old('kuota_maksimal', $gelombang->kuota_maksimal) }}"
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-select-lg @error('jenis_promo') is-invalid @enderror"
                                    ...
                                    <option value="diskon" {{ old('jenis_promo', $gelombang->jenis_promo) == 'diskon' ? 'selected' : '' }}>Diskon</option>
                                    <option value="potongan" {{ old('jenis_promo', $gelombang->jenis_promo) == 'potongan' ? 'selected' : '' }}>Potongan Tetap</option>
                                </select>
                                @error('jenis_promo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control form-control-lg @error('nilai_promo') is-invalid @enderror"
                                       ...
                                       value="{{ old('nilai_promo', $gelombang->nilai_promo) }}"
                                       placeholder="0"
                                       min="0">
                                @error('nilai_promo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-select-lg @error('tipe_nilai_promo') is-invalid @enderror"
                                    ...
                                    <option value="nominal" {{ old('tipe_nilai_promo', $gelombang->tipe_nilai_promo) == 'nominal' ? 'selected' : '' }}>Nominal (Rp)</option>
                                    <option value="persen" {{ old('tipe_nilai_promo', $gelombang->tipe_nilai_promo) == 'persen' ? 'selected' : '' }}>Persentase (%)</option>
                                </select>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('catatan') is-invalid @enderror"
                                  ...
                                  placeholder="Catatan internal untuk admin...">{{ old('catatan', $gelombang->catatan) }}</textarea>
                        @error('catatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror"
                                  ...
                                  placeholder="Informasi tambahan untuk siswa...">{{ old('keterangan', $gelombang->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
