            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center mb-4">
                        <img src="{{ asset('assets/images/my/logo-antartika.png') }}" alt="Logo" style="width: 70px; height: 70px;" class="mb-3">
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                placeholder="Masukkan email Anda" value="{{ session('registered_email') }}" required>
                        </div>
                    ...
                    <div class="text-center mb-3">
                        <a href="{{ route('forgot_password.email_form') }}" class="text-decoration-none">Lupa password?</a>
                    </div>
