            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    @auth
                        <li class="nav-item pe-1">
                            <a class="nav-link"
                                href="/{{ auth()->user()->role == 'admin' ? 'admin' : 'user' }}/dashboard">
                                Dashboard
                            </a>
                        </li>
                    @endauth
        ...
        <div class="top-footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img src="{{ asset('assets/images/my/logo-antartika.png') }}" class="img-fluid mb-3"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col my-1">
                        <p class="text-white mb-0">
                            © {{ date('Y') }} Sekolah SMK Antartika 1. Hak Cipta Dilindungi.
                        </p>
                    </div>
