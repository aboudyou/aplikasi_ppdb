        ...
        <nav class="navbar navbar-expand-md navbar-dark top-nav-collapse default py-0">
            <div class="container">
                <a class="navbar-brand" href="/">
                    <img width="70" src="{{ asset('assets/images/my/logo-antartika.png') }}" alt="logo">
                </a>
        ...
        <footer class="footer bg-dark text-white py-4">
            <div class="top-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/images/my/logo-antartika.png') }}"
                                alt="Logo Sekolah Harapan Bangsa" class="img-fluid mb-3" style="max-width: 200px;">
                            <p class="opacity-75">Sekolah SMK Antartika 1 Sidoarjo berkomitmen untuk mencetak generasi penerus
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <ul class="list-unstyled footer-link">
                                        <li class="d-flex">
                                            ...
                                            <span>Jl. Siwalan Panji, sidoarjo, Indonesia</span>
                                        </li>
                                        <li class="d-flex">
                                            <i class="ti ti-mail me-2 mt-1"></i>
                                            <span>info@SMK Antartika 1.sch.id</span>
                                        </li>
                                        <li class="d-flex">
            ...
            <div class="bottom-footer">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col my-1">
                            <p class="text-white mb-0">© {{ date('Y') }} Sekolah SMK Antartika 1. Hak Cipta
                                Dilindungi.</p>
                        </div>
